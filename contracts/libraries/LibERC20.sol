...
library LibERC20 {
    ...
    ****************************************************************************************/
    ...
    function erc20burn(address account, uint256 amount) internal {
        require(account != address(0), "ERC20: burn from the zero address");

        _erc20_beforeTokenTransfer(account, address(0), amount);
        ...
        _erc20_afterTokenTransfer(account, address(0), amount);
    }
    ...
    function erc20totalSupply() internal view returns (uint256) {
        Storage storage ds = getStorage();
